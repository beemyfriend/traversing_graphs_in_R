...
Other than querying the nodes and edges directly, igraph provides a number of functions to explore graphs. These functions can mostly be grouped as one of the following:
...
* Functions that group components

Here, we will explore the functions of the first three groups. We explore modeling in a seperate section. 
